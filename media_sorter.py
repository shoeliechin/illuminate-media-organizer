...
def get_creation_date(file_path):
    ...
    try:
        ...
        # Fallback to file system's last modification time if no date tags are found
        ...
        # Fallback to file system's last modification time on error
        stat_info = os.stat(file_path)
        return datetime.fromtimestamp(stat_info.st_mtime)
        

def sort_media_files(source_dir, dest_dir, copy_files=False, dry_run=False):
    """
...
if __name__ == '__main__':
    ...
    sort_media_files(args.source_dir, args.dest_dir, args.copy, args.dry_run)
